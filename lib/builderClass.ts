...
const ROLE_BASE: Record<string, BuilderClassInfo> = {
  ...
  'Automation': { name: 'The Automation Architect',   emoji: '⚙️', description: 'You automate what others repeat.' },
...
const STACK_REFINEMENTS: Array<{
  ...
  },
  {
    ...
    minMatch: 2,
    result: { name: 'The UI Sculptor', emoji: '🖌️', description: 'Every pixel has a purpose.' },
  },
  {
    stacks: ['Solidity', 'Web3.js', 'Ethereum', 'Move'],
    minMatch: 1,
    result: { name: 'The Chain Architect', emoji: '⛓️', description: 'You build on trustless foundations.' },
  },
  {
  ...
  },
  {
    ...
    minMatch: 2,
    result: { name: 'The Infrastructure Tactician', emoji: '🏗️', description: 'Your pipelines never sleep.' },
  },
  {
    stacks: ['Python', 'R', 'SQL', 'Spark'],
    minMatch: 2,
    result: { name: 'The Data Cartographer', emoji: '🗺️', description: 'You map the territory of data.' },
  },
];
